                    ...
                    <!-- Content Row -->
                     <?php include('connect.php');
                        if(isset($_POST['update'])){
                                ...
                                $query ="update users_tbl set firstname = '$fname', lastname = '$lname', contactnumber = '$contactnumber',address = '$address',gender = '$gender',username = '$uname', emailaddress = '$emailaddress', password = '$password' where id='$user_id' ";
